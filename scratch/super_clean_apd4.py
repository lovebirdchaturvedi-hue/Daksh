...
src_path = os.path.join(video_dir, "APD GLOBAL BUSINESS 4.mp4")
...
temp_out = os.path.join(video_dir, "temp_apd4.mp4")
...
final_out = os.path.join(video_dir, "APD_GLOBAL_BUSINESS_4_Pure_Clean.mp4")
cmd = [
...
print("SUCCESS: Created APD_GLOBAL_BUSINESS_4_Pure_Clean.mp4 with pure navy background!")
